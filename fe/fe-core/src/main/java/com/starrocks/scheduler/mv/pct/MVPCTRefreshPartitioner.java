...
public abstract class MVPCTRefreshPartitioner {
    ...
    /**
     * Whether this task run is triggered by automatic refresh or not, this is used to distinguish from manual refresh.
     */
    public boolean isAutomaticRefresh() {
        return mvContext.getTaskType().isAutoRefresh() || mvContext.isAutoGeneratedTaskRun();
    }
